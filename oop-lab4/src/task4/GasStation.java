...
public class GasStation extends CarStation implements Refuable {
    private int gasCustomersServed = 0;
    ...
    public GasStation(StationQueue<Car> queue) {
        super(queue);
        ...
        new Thread(() -> {
            while (isRunning) {
                ...
                if (car != null) {
                    ...
                    gasCustomersServed++;
                    System.out.println("\n===============================");
                    System.out.println("Gas car " + car.getCarId() + " has been successfully served.");
                    System.out.println("===============================\n");
                }
            }
        }).start();
    ...
    public void refuel(String carId) {
        System.out.println("\nStarting to refuel car: " + carId + "...");
        try {
            Thread.sleep(2);
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
        System.out.println("Refueling completed for car: " + carId + ".\n");
    }
    ...
    public void stopService() {
        isRunning = false;
        System.out.println("\nThe Gas Station service has been stopped.\n");
    }

    public int getGasCustomersServed() {
        return gasCustomersServed;
    }
